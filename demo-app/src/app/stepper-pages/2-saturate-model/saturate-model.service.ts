...
//Tell TS that Hylar exists as a variable/object somewhere globally
// declare const Hylar: any;

// Hylar has been imported (angular.json)
// declare var Hylar: any;

@Injectable()
export class SaturateModelService {

    getSampleTriples(){

        return `@prefix inst: <https://namespace.example.com/> .
...
inst:1aj%24VJZFn2TxepZUBcKpac a ifc:IfcDoor .`;
    ...
    getSampleOntology(){
        ...
        return `@prefix ccs:    <https://ccs.molio.dk/ontology#> .
@prefix ifc:    <http://ifcowl.openbimstandards.org/IFC2X3_Final#> .
